...
sql.Query("CREATE TABLE IF NOT EXISTS darkp_playermodels(jobcmd VARCHAR(45) NOT NULL PRIMARY KEY, model VARCHAR(140) NOT NULL)")
...
hook.Add("InitPostEntity","darkrp_preferred_jobmodels",function() -- run after the jobs have loaded
