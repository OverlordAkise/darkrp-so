...
function PLAYER_CLASS:Loadout() end
function PLAYER_CLASS:SetModel() end
function PLAYER_CLASS:ShouldDrawLocal() end
function PLAYER_CLASS:CreateMove(cmd) end
function PLAYER_CLASS:CalcView(view) end
function PLAYER_CLASS:GetHandsModel() end
