...
AddCSLuaFile("modules/sleep/sh_sleep.lua")
AddCSLuaFile("modules/positions/sh_commands.lua")
AddCSLuaFile("modules/playerscale/cl_playerscale.lua")
AddCSLuaFile("modules/money/sh_money.lua")
AddCSLuaFile("modules/money/sh_commands.lua")
AddCSLuaFile("modules/language/sh_language.lua")
AddCSLuaFile("modules/language/sh_english.lua")
AddCSLuaFile("modules/jobs/sh_commands.lua")
AddCSLuaFile("modules/hud/sh_chatcommands.lua")
...
AddCSLuaFile("modules/base/sh_commands.lua")
...
include("modules/sleep/sh_sleep.lua")
include("modules/sleep/sv_sleep.lua")
include("modules/positions/sh_commands.lua")
include("modules/positions/sv_spawnpos.lua")
include("modules/positions/sv_database.lua")
--police to bot
include("modules/playerscale/sv_playerscale.lua")
include("modules/money/sh_money.lua")
include("modules/money/sh_commands.lua")
